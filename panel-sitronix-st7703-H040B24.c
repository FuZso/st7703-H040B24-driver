 ...
 * - HOTMI TFT-H040B24ZKIST3C30 4.0" MIPI-DSI panel
 *
...
static void H040B24_init_sequence(struct mipi_dsi_multi_context *dsi_ctx)
{
	/*
	 * Init sequence was supplied by the panel vendor.
	 */
	...
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, ST7703_CMD_SETMIPI,
				0x33, 0x81, 0x05, 0xF9, 0x0E, 0x20,
				0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
				0x00, 0x44, 0x25, 0x00, 0x91, 0x0A,
				0x00, 0x00, 0x02, 0x4F, 0xD1, 0x00,
				0x00, 0x37);
				
	/* Set Power Control extension */
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, ST7703_CMD_SETPOWER_EXT, 0x24, 0x22,
				     0x20, 0x03);
	...
	/* Set RGB interface */
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, ST7703_CMD_SETRGBIF, 0x10, 0x10, 0x0A,
	...
	/* Set power control */
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, ST7703_CMD_SETPOWER, 0x42, 0x00, 0x32,
	...
	/* Set VCOM voltage */
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, ST7703_CMD_SETVCOM, 0xB5, 0xB5);
	...
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, ST7703_CMD_SETGIP2,
				...
				0x58, 0x88, 0x23, 0x10, 0x00, 0x01, 0x02, 0x00,
				0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
static const struct drm_display_mode H040B24_mode = {
	.hdisplay    = 720,
	.hsync_start = 720 + 10,  /* HFP */
	.hsync_end   = 720 + 10 + 4,  /* HSA */
	.htotal	     = 720 + 10 + 4 + 40,  /* HBP */
	.vdisplay    = 720,
	.vsync_start = 720 + 20,  /* VFP */
	.vsync_end   = 720 + 20 + 4,   /* VSA */
	.vtotal	     = 720 + 20 + 4 + 20,   /* VBP */
	.clock	     = 35000,  /* 35MHz */
	.flags	     = DRM_MODE_FLAG_NHSYNC | DRM_MODE_FLAG_NVSYNC,
...
static const struct st7703_panel_desc H040B24_desc = {
	.mode = &H040B24_mode,
	.lanes = 4,
	.mode_flags = MIPI_DSI_MODE_VIDEO | MIPI_DSI_MODE_VIDEO_BURST |
		      MIPI_DSI_MODE_NO_EOT_PACKET | MIPI_DSI_MODE_LPM,
	.format = MIPI_DSI_FMT_RGB888,
	.init_sequence = H040B24_init_sequence,
};
...
static const struct of_device_id st7703_of_match[] = {
	{ .compatible = "H040B24,TFT-H040B24ZKIST3C30", .data = &H040B24_desc },
